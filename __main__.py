...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='MANTIS is a standalone workflow to annotate with HMMER.\n'+
    ...
    parser.add_argument('-sc','--skip_consensus',action='store_true',help='If you would like to skip the consensus generation.')
